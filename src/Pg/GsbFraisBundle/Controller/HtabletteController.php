...
class HtabletteController extends Controller
{
    public function HtabletteAction()
    {
        ...
        $hcouleur= $pdo->gethcouleurtablette($id, $login, $mdp);
        $hmodele= $pdo->gethmodeletablette($id, $login, $mdp);
            return $this->render('PgGsbFraisBundle:Htablette:htablette.html.twig', array(
                    'htablette'=>$htablette, 'hintablette'=>$hintablette, 'hextablette'=>$hextablette, 'hnom'=>$hnom, 'hprenom'=>$hprenom, 'hcouleur'=>$hcouleur, 'hmodele'=>$hmodele));
