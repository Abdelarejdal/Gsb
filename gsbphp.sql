...
--
-- Client :  localhost
-- Généré le :  Lun 14 Décembre 2015 à 22:18
...
INSERT INTO `affectation` (`idnumImmat`, `dateDebut`, `dateFin`, `idVisiteur`) VALUES
('BB-789-RE', '2015-12-01 02:08:05', '2015-12-02 05:09:09', 'a131'),
('CJ-212-TZ', '2015-11-30 04:11:13', '2015-12-01 02:11:03', 'a131'),
('EE-787-MM', '2015-11-04 06:11:14', '2015-12-04 03:08:05', 'a17'),
('UU-144-HJ', '2015-12-01 23:00:00', '2015-12-12 23:00:00', 'a93');
...
('a131', '201511', 0, 0.00, '2015-11-25', 'CR'),
('a131', '201512', 0, 0.00, '2015-12-01', 'CR'),
('a17', '201512', 0, 0.00, '2015-12-01', 'CR');
...
(2, 'a131', '201511', 'cb', '2015-05-12', 144.00);
...
CREATE TABLE IF NOT EXISTS `vehicule` (
  ...
  `marque` char(20) DEFAULT NULL,
  `modele` char(20) DEFAULT NULL,
  `couleur` char(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `vehicule` (`numImmat`, `marque`, `modele`, `couleur`) VALUES
('BB-789-RE', 'citroen', 'c4', 'blanche'),
('CJ-212-TZ', 'renault', 'clio', 'bleu'),
('EE-787-MM', 'peugeot', '207', 'rouge'),
('UU-144-HJ', 'peugeot', '307', 'vert');
...
ALTER TABLE `affectation`
 ADD PRIMARY KEY (`idnumImmat`,`dateDebut`), ADD KEY `refVisiteur` (`idVisiteur`), ADD KEY `idVisiteur` (`idVisiteur`), ADD KEY `refnumImmat` (`idnumImmat`);
...
--
ALTER TABLE `affectation`
ADD CONSTRAINT `affectation_ibfk_2` FOREIGN KEY (`idVisiteur`) REFERENCES `Visiteur` (`id`),
ADD CONSTRAINT `affectation_ibfk_3` FOREIGN KEY (`idnumImmat`) REFERENCES `vehicule` (`numImmat`);
